<template>
<section class="mt-32 relative" id="about">
    <!-- Background div for desktop -->
    <div class="hidden lg:block absolute right-0 w-3/4 h-full bg-gray-100 rounded"></div>
    
    <div class="container mx-auto px-6 py-10 relative">
        <h1 class="text-4xl font-semibold capitalize lg:text-3xl">
            Sobre <span class="text-psicoletos">Mí:</span>
        </h1>
        ...
        <div class="mt-10 lg:mt-20 lg:flex lg:items-start">
            ...
            <div class="mt-8 lg:w-1/2 lg:px-10 lg:mt-0">
                ...
                <h3 class="mt-8 text-lg font-medium">
                    Mi objetivo es desmitificar la salud mental y proporcionar herramientas accesibles para que todos puedan cuidar de su bienestar psicológico.
                </h3>
            </div>
        </div>
    </div>
